...
import { ReceptionistComponent } from 'app/entities/receptionist/receptionist.component';
...
describe('Component Tests', () => {
  describe('Receptionist Management Component', () => {
    let comp: ReceptionistComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReceptionistComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.receptionists && comp.receptionists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
