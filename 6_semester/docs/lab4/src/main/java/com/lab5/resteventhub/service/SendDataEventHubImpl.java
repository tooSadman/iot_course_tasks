...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("eventhublab")//namespace
                .setEventHubName("eventhubdocslab")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://eventhublab.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=0gH7NOZz6o2YgofVhqET9rfFDHetKilQDMvVuJRc3ig=;EntityPath=eventhubdocslab")
                /*Primary key*/
                .setSasKey("0gH7NOZz6o2YgofVhqET9rfFDHetKilQDMvVuJRc3ig=");
