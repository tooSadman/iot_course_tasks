...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private final static String CACHE_HOSTNAME = "docs.redis.cache.windows.net";
    private final static String CACHE_KEY = "7wuotyu7b+NsyiSN05pMfx8Q+g4LdXR2v8wMFUzfxWs=";
