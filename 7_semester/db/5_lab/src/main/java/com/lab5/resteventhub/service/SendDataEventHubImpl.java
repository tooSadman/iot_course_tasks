...
public class SendDataEventHubImpl implements SendDataService {
    ...
    public void sendAndLog(String url) throws IOException, EventHubException {
        final ConnectionStringBuilder connStr = new ConnectionStringBuilder()
                .setNamespaceName("iot-db-lab")//namespace
                .setEventHubName("iot-db-eventhub")//hub name
                /*Connection string–primary key*/
                .setSasKeyName("Endpoint=sb://iot-db-lab.servicebus.windows.net/;SharedAccessKeyName=iot-eh-listen;SharedAccessKey=S9LdfhG+dWks/uq1WXjhaRFPqyO8S3PrSev39ekavn8=")
                /*Primary key*/
                .setSasKey("S9LdfhG+dWks/uq1WXjhaRFPqyO8S3PrSev39ekavn8=");
