...
public class SendDataConsoleImpl implements SendDataService {
    ...
    private final static String CACHE_HOSTNAME = "iot-lab.redis.cache.windows.net";
    private final static String CACHE_KEY = "IoQgH3VNqLD8OJ6o7r4HB57AIVZvp64ADmIdP4f4bfU=";
